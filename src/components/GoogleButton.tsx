...
export default function GoogleButton({ invite }: { invite?: string }) {
  ...
  return (
    <button onClick={signIn} disabled={loading} className="btn-ghost w-full">
      <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.2 0 10-2 13.6-5.2l-6.3-5.2C29.2 35 26.7 36 24 36c-5.3 0-9.7-3.1-11.3-7.6l-6.5 5C9.5 39.6 16.2 44 24 44z"
        />
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.6l6.3 5.2C41.6 35.9 44 30.4 44 24c0-1.3-.1-2.3-.4-3.5z"
        />
      </svg>
